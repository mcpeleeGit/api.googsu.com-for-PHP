  ...
  render() {
    return (
      <div className="text-center">
        ...
        제 1 장 총 칙<br/>
제 1 조 (목적)<br/>
이 약관은 국수닷컴(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.<br/>
<br/>
...
③ 아이디(ID) : 회원의 식별과 서비스 이용을 사이트가 생성하는 일련번호를 말합니다.<br/>
...
제5장 계약사항의 변경, 해지<br/>
제 12 조 (정보의 변경)<br/>
회원이 배송주소, 비밀번호 등 고객정보를 변경하고자 하는 경우에는 홈페이지의 회원정보 변경 서비스를 이용하여 변경할 수 있습니다.<br/>
<br/>
제 13 조 (계약사항의 해지)<br/>
...
<br/>
[부칙]<br/>
(시행일) 이 약관은 2020년 01월부터 시행합니다.<br/>
            </div>
            <hr/>
