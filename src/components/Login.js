...
export class Login extends Component {
  ...
  constructor() {
    super();
    this.state = { kakaologinLink: "", email: '', password: '', data: [], isLoading: true };
  ...
  componentDidMount() {
    axios.get('/api/kakao/login/loginLink').then((response) => {
      console.log(response.data);
      this.setState({ kakaologinLink: response.data.result });
    });
  }
